...
function prismaObjectDefinitionBlock(typeName, t, prismaType, prismaSchema) {
    var prismaBlock = t;
    ...
    prismaBlock.prismaFields = function (inputFields) {
        ...
        graphqlType.getInterfaces().forEach(function (interfaceType) {
...
exports.prismaObjectDefinitionBlock = prismaObjectDefinitionBlock;
function prismaTypeObject(datamodelInfo, objectConfig, builderConfig) {
    var typeName = objectConfig.name;
...
exports.prismaTypeObject = prismaTypeObject;
